...
const Solutions = () => {
  return (
    ...
    <section class=" bg-blue-950 ray-50">
      <div class="py-1  sm:py-16 block lg:py-24 relative bg-opacity-50 z-0" >
        <h2 className='text-white text-center	font-semibold font-serif text-3xl mt-4'>What We Offer</h2>
          ...
          <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
            <div class="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-3 lg:mt-20">
              <a href="#"
                ...
                <div
                  class=" absolute  bg-blue-600/50 top-0 left-0 w-24 h-1 z-30  transition-all duration-200   group-hover:bg-white group-hover:w-1/2  ">
                </div>
                <div class="py-2 px-9 relative">
                  <FaRegFileLines size={70} color='#787FF1' />
                  <h3 class="mt-8 text-lg font-semibold text-black">Invoice Discounting</h3>
              ...
              <a href="#"
                ...
                <div class="py-2 px-9 relative">
                  ...
                  <h3 class="mt-8 text-lg font-semibold text-black group-hover:text-white ">Vendor Financing</h3>
                  <p class="mt-4 text-base text-gray-600">
              ...
              <a href="#"
                ...
                <div class="py-2 px-9 relative">
                  ...
                  {/* <FaRegFileLines size={70} color='#787FF1'/> */}
                  <h3 class="mt-8 text-lg font-semibold text-black">Export Credits</h3>
                  <p class="mt-4 text-base text-gray-600 ">
