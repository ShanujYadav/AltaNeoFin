...
import exp from '../../../../public/assets/img/exp.png';
    ...
    return (
        <div className="bg-gray-900 text-gray-100  min-h-screen p-6 overflow-hidden">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-8xl  text-center mt-6">
                <h1 className="text-2xl font-bold text-black text-center mb-6">WHY ALTANEO FOR EXPORT CREDITS</h1>
                <div className="flex flex-col md:flex-row items-center md:items-start">
                    ...
                    <div className="md:w-1/2 mt-6 md:mt-0 md:ml-8">
                        <img className="w-full h-80 object-cover" src={exp} alt="Gartner Magic Quadrant" />
                    </div>
                </div>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-8xl text-center mt-6">
