        ...
        <body class="text-gray-800 font-inter">
            <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
                <a href="#" class="flex items-center pb-4 border-b border-b-gray-800">
                    <h2 class="font-bold text-2xl">Alta<span class="bg-blue-700 text-white px-2 rounded-md">Neo</span></h2>
                </a>
                <ul class="mt-4">
                    ...
                    <li className="mb-1 group">
                        ...
                        >
                            ...
                            <span className="text-sm flex-grow">Users</span>
                            {isOpen ?
                            ...
                            <i
                                className={`ri-arrow-right-s-line ml-2 transition-transform ${isOpen ? 'rotate-90' : ''}`}
                            ></i>
                        </a>
