        ...
        <div class="flex flex-col sm:flex-row sm:space-x-4 space-y-2 sm:space-y-0 overflow-x-hidden mt-5 pt-3">
            <div class="w-full sm:w-2/5 h-full flex items-center justify-center">
                <div class="bg-white p-6 rounded-lg w-full max-w-md">
                    <h1 class="font-bold text-2xl p-6 text-center mb-6">Simple Interest Calculator</h1>
                    <hr />
            ...
            <div class="w-full sm:w-3/5 bg-white h-96 flex items-center justify-center pt-3">
                {/* <img src="8.png" alt="Description of image" class="w-full h-auto"> */}
            </div>
        </div>
    )
}
