...
import cta2 from '../../../assets/img/ctaImg.png';
      ...
      <div className="min-h-screen bg-white mb-4 flex flex-col justify-center py-8 overflow-x-hidden">
        <section className="text-gray-400 bg-white body-font">
          <div className="container mx-auto px-4 py-12 lg:py-24">
            ...
            <h2 className="text-gray-700 text-2xl text-center font-serif italic underline font-semibold mt-20">More Blogs by Jyotika</h2>
