          ...
          <div className="h-full max-h-screen overflow-auto">
            ...
            <div className="p-6">
              ...
              <ul class="list-disc mt-2 text-gray-600 list-inside font-serif dark:text-gray-600 text-[18px] text-justify space-y-2">
                <li className='leading-tight mb-3 text-[18px] font-serif text-gray-600 text-justify'>Blockchain technology promises to revolutionise supply chain finance by enhancing transparency and security.</li>
              ...
              <ul class="list-disc mt-2 font-serif text-gray-600 list-inside dark:text-gray-600 text-[18px] text-justify space-y-2">
                <li className='leading-tight mb-3 text-[18px] font-serif text-gray-600 text-justify'>AI and machine learning are enabling predictive analytics in supply chain finance, allowing companies to forecast demand, assess risk, and make informed decisions.</li>
                <li className='leading-tight mb-3 text-[18px] font-serif text-gray-600 text-justify'>
              ...
              <ul class="list-disc mt-2 text-gray-600 list-inside font-serif dark:text-gray-600 text-[18px] text-justify space-y-2">
                <li className='leading-tight mb-3 text-[18px] font-serif text-gray-600 text-justify'>Green financing options, such as green bonds and sustainability-linked loans, are becoming more prevalent. These financial instruments are tied to specific environmental, social, and governance (ESG) criteria.</li>
              ...
              <ul class="list-disc mt-2 text-gray-600 font-serif list-inside dark:text-gray-600 text-[18px] text-justify space-y-2">
                <li className='leading-tight mb-3 text-[18px] font-serif text-gray-600 text-justify'>Small and medium-sized enterprises (SMEs) often face challenges in accessing financing. Future SCF trends will focus on making financing more accessible to these businesses.</li>
                <li className='leading-tight mb-3 text-[18px] font-serif text-gray-600 text-justify'>
