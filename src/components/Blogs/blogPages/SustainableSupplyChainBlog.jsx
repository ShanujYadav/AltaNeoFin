      ...
      <div className="col-span-1 flex items-center sm:col-span-8 mt-2 pt-4">
        <div className="h-full rounded-xl shadow-cla-blue bg-white lg:items-center lg:px-8 pt-2 overflow-hidden w-full">
          <div className="h-full max-h-screen overflow-auto">
            ...
            <div className="p-6">
              <h1 ref={refs.current[1]} className="mt-2 mb-1 text-3xl md:text-3xl lg:text-4xl font-bold leading-none text-start">
                Sustainable Supply Chain Finance - Green Financing and ESG Integration
              </h1>
              <h1  className="mt-2 mb-1 text-xl md:text-xl lg:text-2xl font-semibold leading-none text-start">
                Introduction -
              </h1>
              <p  ref={refs.current[2]} className="leading-tight mb-3 text-[18px] text-gray-600 text-justify">
              ...
              <h1  className="mt-2 mb-1 text-xl md:text-xl lg:text-2xl font-semibold leading-none text-start font-sans">
                What is Sustainable Supply Chain Finance
              </h1>
              <p  ref={refs.current[3]} className="leading-tight mb-3 text-[18px] text-gray-600 text-justify">
              ...
              <p  ref={refs.current[4]} className="leading-tight mb-3 text-[18px] text-gray-600 text-justify">
              ...
              <p ref={refs.current[6]} className="leading-tight mb-3 text-[18px] text-gray-600 text-justify">
              ...
              <h1  className="my-2 text-xl md:text-xl lg:text-2xl font-semibold leading-none text-start">
                How AltaneoFin Applies ESG in Their Business
              </h1>

              <p className="leading-tight mb-3 text-[18px] text-gray-600 text-justify">
              ...
              <ul className="list-disc mt-2 text-gray-600 list-inside dark:text-gray-600 text-[18px] text-justify space-y-2">
                <li>
              ...
              <p ref={refs.current[9]} className="leading-tight mb-3 text-[18px] text-gray-600 text-justify">
              ...
              <h1  className="mt-4 mb-1 text-2xl md:text-2xl lg:text-3xl font-semibold leading-none text-start">
                Conclusion
              </h1>
              <p  className="leading-tight mb-3 text-[18px] text-gray-600 text-justify">
        ...
        <div className="">
          ...
          <ol className="mt-2 text-gray-600 list-inside dark:text-gray-600 text-[20px] text-justify space-y-2">
            <li onClick={() => scrollToElement(1)}>
              <span className="font-medium leading-relaxed text-gray-700 hover:text-blue-600 cursor-pointer">
                1. Introduction
              </span>
            </li>
