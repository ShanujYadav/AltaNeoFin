        ...
        <div className="h-full rounded-xl shadow-cla-blue bg-white lg:items-center lg:px-8 pt-2 overflow-hidden w-full">
          <div className="h-full max-h-screen overflow-auto">
            ...
            <div class="p-6">
              ...
              <h1 class="mt-4 mb-1 text-2xl md:text-2xl lg:text-3xl font-semibold leading-none text-start font-serif"><a href="/" className='text-blue-600'>AltaneoFin</a> - A Supply Chain Financing Solution Provider </h1>
              ...
              <h1 class="mt-4 mb-1 text-2xl md:text-2xl lg:text-3xl font-semibold leading-none text-start font-serif">Conclusion</h1>
              <p class="leading-tight	 mb-3 text-[18px] text-gray-600 text-justify font-serif">
      ...
      <div class="col-span-1 rounded-lg p-4 sm:col-span-4">
        ...
        <ol class="mt-2 text-gray-600 list-inside dark:text-gray-600 text-[20px] text-justify space-y-2">
          ...
          <li onClick={() => scrollToElement(4)} className='font-medium leading-relaxed text-gray-700 font-serif hover:text-blue-600 cursor-pointer'>
              4.How AltaneoFin Supports Buyers with SCF
          </li>
          ...
          <li onClick={() => scrollToElement(6)} className='font-medium leading-relaxed text-gray-700 font-serif hover:text-blue-600 cursor-pointer'>
              6. Conclusion
          </li>
        </ol>
      </div>
