  ...
  return (
    <div className='w-full mt-5 grid grid-cols-1 gap-4 p-4 sm:grid-cols-12'>
      <div class="col-span-1 flex items-center sm:col-span-8">
        <div class="h-full rounded-xl shadow-cla-blue bg-white lg:items-center lg:px-8 pt-2 overflow-hidden w-full">
          <div class="h-full max-h-screen overflow-auto">
            ...
            <div class="p-6">
              ...
              <p class="leading-tight mb-3 text-[18px] text-gray-600 text-justify">
                Each transaction, or "block," is time-stamped and linked to the previous one, forming a "chain" of data that is tamper-proof and accessible to all participants in the network            </p>
              ...
              <h1 ref={refs.current[3]} class="mt-2 mb-1 text-xl md:text-xl lg:text-2xl font-semibold leading-none text-start">
              ...
              <ul class="list-disc mt-2 text-gray-600 list-inside dark:text-gray-600 text-[18px] text-justify space-y-2">
                ...
                <li>
                  ...
                  As the volume of transactions on a blockchain increases, scalability can become a concern. Businesses must ensure that their blockchain solutions can handle large volumes of transactions without compromising performance or security. </li>
              ...
              <h1 class="mt-4 mb-1 text-2xl md:text-2xl lg:text-3xl font-semibold leading-none text-start">
                Conclusion
              </h1>
              <p class="leading-tight mb-3 text-[18px] text-gray-600 text-justify">
      ...
      <div class="col-span-1 rounded-lg p-4 sm:col-span-4">
        ...
        <ol class="mt-2 text-gray-600 list-inside dark:text-gray-600 text-[20px] text-justify space-y-2">
          ...
          <li>
            <span class="font-medium leading-relaxed text-gray-700">
              8. How AltaneoFin Applies ESG in Their Business
            </span>
          </li>
          <li>
            <span class="font-medium leading-relaxed text-gray-700 ">
